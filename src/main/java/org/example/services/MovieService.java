...
public class MovieService {
    ...
    public void createMovies (List<MovieDTO> movieDTOs, EntityManagerFactory emf) {
        ...
        try {
            ...
            for (MovieDTO movieDTO : movieDTOs) {
                ...
                movie.setLowerRating(movieDTO.getLowerRating());
                movie.setUpperRating(movieDTO.getUpperRating());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            movieService.createMovies(danishMovies, emf);
